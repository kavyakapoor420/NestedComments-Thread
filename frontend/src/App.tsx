          ...
          <Routes>
              ...
              element={
                !user ? (
                  <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
                    <AuthForm type="login" onSuccess={() => navigate('/comments')} />
            ...
            <Route
              ...
              element={
                !user ? (
                  <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
                    <AuthForm type="register" onSuccess={() => navigate('/login')} />
                    <p className="mt-4 text-gray-600">
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <CommentsSection currentUserId={user?.id || 0} />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            />
            <Route path="*" element={<Navigate to={user ? '/comments' : '/login'} replace />} />
          </Routes>
        </div>
      );
    };
